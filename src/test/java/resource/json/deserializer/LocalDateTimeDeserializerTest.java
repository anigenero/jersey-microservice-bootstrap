...
public class LocalDateTimeDeserializerTest extends DeserializerBase<LocalDateTimeDeserializer, LocalDateTime> {
    ...
    @Test
    public void deserializeEpochTime() throws Exception {
